######## RAW VALUES: RESEARCH QUESTION 10 ########
...
cat("=== RQ10 Graph 1: Does the Policy Help Close the Achievement Gap? ===\n")
...
cat("\n=== RQ10 Graph 2: Does the Policy Ensure Success for At-Risk Students? ===\n")
