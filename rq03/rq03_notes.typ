#set document(title: "RQ03 — Extension Reasons")
...
#align(center)[
  ...
  #v(0.2em)
  #text(size: 12pt, style: "italic")[Extension Reasons]
  #v(0.4em)
  #line(length: 100%)
]
...
#v(0.3em)
#figure(
  image("rq03_graph.png", width: 100%),
  caption: [Top 5 reasons for requesting extensions.]
)
...
*X-axis (flipped):* Number of students \
*Y-axis (flipped):* Reason category \
